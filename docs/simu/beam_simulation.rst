...
.. note:: 
    ...
    The original simulation was performed with NEC2.0 with a model of the radiator over a 3x3 grid on top of an infinite "Average ground" (AG, :math:`\\sigma`=5mS/m, :math:`\\epsilon_r`=13). The interested reader can ask the team for details.
